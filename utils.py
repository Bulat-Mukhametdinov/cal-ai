...
def replace_formulas(model, text):
    ...
    **Не забудь ответить на том же языке что и входное сообщение (если оно на английском то отвечать также следует на английском, если на русском то на русском.**
